...
void cache_oblv(float **A, float **B, float **C, int N, int Ai, int Aj, int Bi, int Bj, int Ci, int Cj) {
 ...
 //  printf("the block size: %d\n",bs); 
  if (N==Ncut) {
    ...
    cache_oblv(A,B,C,bs, Ai, Aj, Bi, Bj, Ci, Cj); cache_oblv(A,B,C,bs, Ai, Aj+bs, Bi, Bj+bs, Ci, Cj);//print_matrix(C,N);
    cache_oblv(A,B,C,bs, Ai, Aj, Bi+bs, Bj, Ci, Cj+bs); cache_oblv(A,B,C,bs, Ai, Aj+bs, Bi+bs, Bj+bs, Ci, Cj+bs);
    cache_oblv(A,B,C,bs, Ai+bs, Aj, Bi, Bj, Ci+bs, Cj); cache_oblv(A,B,C,bs, Ai+bs, Aj+bs, Bi, Bj+bs, Ci+bs, Cj);
    cache_oblv(A,B,C,bs, Ai+bs, Aj, Bi+bs, Bj, Ci+bs, Cj+bs); cache_oblv(A,B,C,bs, Ai+bs, Aj+bs, Bi+bs, Bj+bs, Ci+bs, Cj+bs);
