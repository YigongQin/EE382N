...
int main(int argc, char** argv)
{
    ...
    //
    cudaMallocManaged((void**)&xarray, total_elems*sizeof(float));
    cudaMallocManaged((void**)&yarray, total_elems*sizeof(float));
    cudaMallocManaged((void**)&resultarray, total_elems*sizeof(float));
